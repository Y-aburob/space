            ...
            <div className='mainCrew'>
                ...
                <div className='flex flex-col items-center justify-center p-4 mt-20 lg:h-screen lg:mt-0 lg:pb-3'>
                    ...
                    {crewList.map((crews, index) => (
                        <div key={index} className={`container flex flex-col items-center justify-center lg:pl-20 lg:flex-row lg:justify-start lg:gap-40 ${crews.id === currentId? 'flex': 'hidden'}`}>
